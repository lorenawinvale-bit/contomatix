 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-recruiting-the-woodlands-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-recruiting-the-woodlands-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-recruiting-the-woodlands-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// audit-blog-post-recruiting-moses-lake-2026.js): this copy hardcodes the
// recruiting phrasing for The Woodlands instead.
const FOCUS_KEYWORD_PATTERNS = [
  /recruiting companies the woodlands/i,
  /recruiting companies in the woodlands/i,
  /top recruiting companies in the woodlands/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "recruiting companies in The Woodlands" (or close variant) near the start'
);
