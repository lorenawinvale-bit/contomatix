 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-marketing-agencies-the-woodlands-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-marketing-agencies-the-woodlands-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-marketing-agencies-the-woodlands-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// the marketing-agencies phrasing for The Woodlands instead.
const FOCUS_KEYWORD_PATTERNS = [
  /marketing agencies the woodlands/i,
  /marketing agencies in the woodlands/i,
  /top marketing agencies in the woodlands/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "marketing agencies in The Woodlands" (or close variant) near the start'
);
