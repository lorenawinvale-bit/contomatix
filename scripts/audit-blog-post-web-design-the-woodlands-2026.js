 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-web-design-the-woodlands-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-web-design-the-woodlands-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-web-design-the-woodlands-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// audit-blog-post-graphic-design-the-woodlands-2026.js and
// audit-blog-post-web-design-sugar-land-2026.js): this copy hardcodes the
// web-design phrasing for The Woodlands instead.
const FOCUS_KEYWORD_PATTERNS = [
  /web design companies the woodlands/i,
  /web design companies in the woodlands/i,
  /top web design companies in the woodlands/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "web design companies in The Woodlands" (or close variant) near the start'
);
