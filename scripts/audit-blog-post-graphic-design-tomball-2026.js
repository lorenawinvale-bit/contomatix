 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-graphic-design-tomball-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-graphic-design-tomball-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-graphic-design-tomball-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// audit-blog-post-tomball-seo-2026.js): the generic recruiting-series script
// hardcodes "recruiting companies <city>" phrasing, which doesn't fit a
// graphic-design-companies post, so this copy hardcodes the graphic-design
// phrasing for Tomball instead.
const FOCUS_KEYWORD_PATTERNS = [
  /top graphic design companies tomball/i,
  /graphic design companies tomball/i,
  /top graphic design companies in tomball/i,
  /graphic design companies in tomball/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "top graphic design companies in Tomball" (or close variant) near the start'
);
