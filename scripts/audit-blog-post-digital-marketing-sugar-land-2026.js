#!/usr/bin/env node
/**
 * Blog post pre-publish audit script — Sugar Land digital marketing post variant.
 *
 ...
 *
 * This is a copy of scripts/audit-blog-post-graphic-design-sugar-land-2026.js
 * (itself a copy of the recruiting-series base script, scripts/audit-blog-post.js)
 * adapted for the "Top 4 Verified Digital Marketing Agencies in Sugar Land, TX"
 * post: the focus-keyword patterns are swapped for this post's topic/city, and
 * the "Best fit for:"/"Pricing:" separate-<p>-tag check (added for the
 * recruiting/graphic-design profile format) is retained.
 *
 * Usage:
 *   node scripts/audit-blog-post-digital-marketing-sugar-land-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-digital-marketing-sugar-land-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-digital-marketing-sugar-land-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
const FOCUS_KEYWORD_PATTERNS = [
  /digital marketing agencies in sugar land/i,
  /digital marketing agencies sugar land/i,
  /top digital marketing agencies in sugar land/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "digital marketing agencies in Sugar Land" (or close variant) near the start'
);
