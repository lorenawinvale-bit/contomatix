 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-sugar-land-seo-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-sugar-land-seo-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-sugar-land-seo-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// audit-blog-post-pleasanton.js and audit-graphic-design-reno-2026.js): the
...
// SEO-companies phrasing for Sugar Land instead.
const FOCUS_KEYWORD_PATTERNS = [
  /top seo companies sugar land/i,
  /seo companies sugar land/i,
  /top seo companies in sugar land/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "top SEO companies in Sugar Land" (or close variant) near the start'
);
