 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-marketing-agencies-tomball-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-marketing-agencies-tomball-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-marketing-agencies-tomball-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// audit-blog-post-tomball-seo-2026.js and audit-blog-post-digital-marketing-tomball-2026.js):
// the generic recruiting-series script hardcodes "recruiting companies <city>"
// phrasing, which doesn't fit a marketing-agencies post, so this copy hardcodes
// the marketing-agencies phrasing for Tomball instead.
const FOCUS_KEYWORD_PATTERNS = [
  /top marketing agencies tomball/i,
  /marketing agencies tomball/i,
  /top marketing agencies in tomball/i,
  /marketing agencies in tomball/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "top marketing agencies in Tomball" (or close variant) near the start'
);
