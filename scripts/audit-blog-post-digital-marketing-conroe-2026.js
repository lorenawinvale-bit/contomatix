 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-digital-marketing-conroe-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-digital-marketing-conroe-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-digital-marketing-conroe-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// audit-blog-post-digital-marketing-the-woodlands-2026.js): this copy hardcodes
// the digital-marketing phrasing for Conroe, TX instead.
const FOCUS_KEYWORD_PATTERNS = [
  /digital marketing agencies conroe/i,
  /digital marketing agencies in conroe/i,
  /top digital marketing agencies in conroe/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "digital marketing agencies in Conroe" (or close variant) near the start'
);
