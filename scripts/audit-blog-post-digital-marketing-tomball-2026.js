 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-digital-marketing-tomball-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-digital-marketing-tomball-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-digital-marketing-tomball-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// ---------------------------------------------------------------------------
// Series-specific copy of the base audit script (same pattern as
// audit-blog-post-tomball-seo-2026.js): this copy hardcodes the "digital
// marketing agencies Tomball" phrasing instead of the generic recruiting or
// SEO-companies phrasing used by the other series scripts.
const FOCUS_KEYWORD_PATTERNS = [
  /top digital marketing agencies in tomball/i,
  /digital marketing agencies tomball/i,
  /top digital marketing agencies tomball/i,
  /digital marketing agencies in tomball/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "top digital marketing agencies in Tomball" (or close variant) near the start'
);
