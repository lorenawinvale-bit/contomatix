 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-graphic-design-cypress-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-graphic-design-cypress-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-graphic-design-cypress-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// audit-blog-post-graphic-design-tomball-2026.js): the generic recruiting-series
...
// phrasing for Cypress instead.
const FOCUS_KEYWORD_PATTERNS = [
  /top graphic design companies cypress/i,
  /graphic design companies cypress/i,
  /top graphic design companies in cypress/i,
  /graphic design companies in cypress/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "top graphic design companies in Cypress" (or close variant) near the start'
);
