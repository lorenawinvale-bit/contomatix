 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-seo-manchester-uk-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-seo-manchester-uk-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-seo-manchester-uk-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// audit-blog-post-sugar-land-seo-2026.js): that copy hardcodes "SEO companies
// Sugar Land" phrasing, which doesn't fit this Manchester, UK "SEO agencies"
// post, so this copy hardcodes the Manchester-agencies phrasing instead.
const FOCUS_KEYWORD_PATTERNS = [
  /top seo agencies in manchester/i,
  /seo agencies manchester/i,
  /seo agencies in manchester/i,
  /top seo agencies manchester/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "top SEO agencies in Manchester, UK" (or close variant) near the start'
);
