 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-graphic-design-league-city-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-graphic-design-league-city-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-graphic-design-league-city-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// phrasing for League City instead.
const FOCUS_KEYWORD_PATTERNS = [
  /top graphic design companies league city/i,
  /graphic design companies league city/i,
  /top graphic design companies in league city/i,
  /graphic design companies in league city/i,
];
