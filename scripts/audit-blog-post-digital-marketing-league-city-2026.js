 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-digital-marketing-league-city-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-digital-marketing-league-city-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-digital-marketing-league-city-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// the digital-marketing phrasing for League City, TX instead.
const FOCUS_KEYWORD_PATTERNS = [
  /digital marketing agencies league city/i,
  /digital marketing agencies in league city/i,
  /top digital marketing agencies in league city/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "digital marketing agencies in League City" (or close variant) near the start'
);
