 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-digital-marketing-cypress-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-digital-marketing-cypress-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-digital-marketing-cypress-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// the digital-marketing phrasing for Cypress, TX instead.
const FOCUS_KEYWORD_PATTERNS = [
  /digital marketing agencies cypress/i,
  /digital marketing agencies in cypress/i,
  /top digital marketing agencies in cypress/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "digital marketing agencies in Cypress" (or close variant) near the start'
);
