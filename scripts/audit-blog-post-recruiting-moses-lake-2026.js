 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-recruiting-moses-lake-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-recruiting-moses-lake-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-recruiting-moses-lake-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// audit-blog-post-sugar-land-seo-2026.js and audit-graphic-design-reno-2026.js):
// this copy hardcodes the "recruiting companies Moses Lake" phrasing.
const FOCUS_KEYWORD_PATTERNS = [
  /top recruiting companies in moses lake/i,
  /recruiting companies moses lake/i,
  /top recruiting companies moses lake/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "top recruiting companies in Moses Lake" (or close variant) near the start'
);
