 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-tomball-seo-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-tomball-seo-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-tomball-seo-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// audit-blog-post-sugar-land-seo-2026.js and audit-blog-post-pleasanton.js):
// the generic recruiting-series script hardcodes "recruiting companies <city>"
// phrasing, which doesn't fit an SEO-companies post, so this copy hardcodes
// the SEO-companies phrasing for Tomball instead.
const FOCUS_KEYWORD_PATTERNS = [
  /top seo companies tomball/i,
  /seo companies tomball/i,
  /top seo companies in tomball/i,
  /seo companies in tomball/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "top SEO companies in Tomball" (or close variant) near the start'
);
