 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-graphic-design-the-woodlands-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-graphic-design-the-woodlands-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-graphic-design-the-woodlands-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// audit-graphic-design-reno-2026.js and audit-blog-post-boulder-graphic-design-2026.js):
// this copy hardcodes the graphic-design phrasing for The Woodlands instead.
const FOCUS_KEYWORD_PATTERNS = [
  /graphic design companies the woodlands/i,
  /graphic design companies in the woodlands/i,
  /top graphic design companies in the woodlands/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "graphic design companies in The Woodlands" (or close variant) near the start'
);
