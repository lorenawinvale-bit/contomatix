 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-marketing-agencies-league-city-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-marketing-agencies-league-city-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-marketing-agencies-league-city-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// audit-blog-post-digital-marketing-league-city-2026.js): the generic
...
// marketing-agencies phrasing for League City instead.
const FOCUS_KEYWORD_PATTERNS = [
  /top marketing agencies league city/i,
  /marketing agencies league city/i,
  /top marketing agencies in league city/i,
  /marketing agencies in league city/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "top marketing agencies in League City" (or close variant) near the start'
);
