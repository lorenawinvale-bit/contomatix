...
const FOCUS_KEYWORD_PATTERNS = [
  /guest posting vs\.? niche edits/i,
  /guest posting and niche edits/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "guest posting vs niche edits" (or close variant) near the start'
);
