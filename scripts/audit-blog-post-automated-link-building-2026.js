...
const FOCUS_KEYWORD_PATTERNS = [
  /automated link building/i,
  /automated link-building/i,
  /link building automation/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "automated link building" (or close variant) near the start'
);
