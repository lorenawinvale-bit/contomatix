 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-web-design-tomball-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-web-design-tomball-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-web-design-tomball-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// audit-blog-post-graphic-design-tomball-2026.js and
// audit-blog-post-tomball-seo-2026.js): this post is a 5-result "top N" list
// for Tomball web design specifically, so the focus keyword is "web design
// companies Tomball" / "top 5 web design companies in Tomball" rather than
// the SEO, digital-marketing, or graphic-design phrasing used by the sister
// Tomball posts.
const FOCUS_KEYWORD_PATTERNS = [
  /top 5 web design companies (in )?tomball/i,
  /web design companies tomball/i,
  /web design companies in tomball/i,
];
...
check(
  ...
  boldedInFirst10Pct,
  boldedInFirst10Pct ? 'OK' : 'expected a <strong> tag matching "top 5 web design companies in Tomball" (or close variant) near the start'
);
