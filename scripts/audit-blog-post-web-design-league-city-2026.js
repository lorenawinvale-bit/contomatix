 ...
 *
 * Usage:
 *   node scripts/audit-blog-post-web-design-league-city-2026.js <draft.json>              (dry run, default)
 *   node scripts/audit-blog-post-web-design-league-city-2026.js <draft.json> --write      (append to blog.json)
 *
...
if (!draftArg) {
  console.error('Usage: node scripts/audit-blog-post-web-design-league-city-2026.js <draft.json> [--write]');
  process.exit(1);
}
...
// audit-blog-post-web-design-cypress-2026.js and audit-blog-post-seo-conroe-2026.js):
// this post is an honest "Top 1" verified-pick post for League City, TX web
// design specifically, so the focus keyword is "web design companies League
// City" / "top web design companies in League City, TX" rather than the SEO,
// digital-marketing, or graphic-design phrasing used by sister posts for
// other cities.
const FOCUS_KEYWORD_PATTERNS = [
  /top web design companies (in )?league city/i,
  /web design companies league city/i,
  /web design companies in league city/i,
  /web design company (in )?league city/i,
];
