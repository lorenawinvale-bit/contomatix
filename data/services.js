module.exports = [
  {
    ...
    points: [
      ...
      'Every site manually vetted before outreach — no PBNs, no automation',
      'Target list shared with metrics before any placement goes live',
      'Anchor text diversity tracked to keep the profile looking natural'
    ],
    faqs: [
      ...
      { q: 'How long before a new link affects rankings?', a: "Google typically has to recrawl the linking page and reprocess your site's link graph first, which usually takes a few weeks. Movement from any single link is gradual — the compounding effect across a sustained campaign is what actually moves rankings, not any one placement." },
      { q: 'Do you guarantee a specific domain rating or number of referring domains?', a: "No — anyone promising a guaranteed DR is optimizing for a vanity metric, not rankings. We report DR and referring domains alongside relevance and traffic because a high-DR link with no topical fit or real traffic is worth less than a mid-DR link that is genuinely relevant." }
    ]
  },
  {
    slug: 'guest-posting',
    ...
    points: [
      ...
      'Publisher vetted for real organic traffic before outreach',
      'Topic and angle agreed with you before drafting begins'
    ],
    faqs: [
      ...
      { q: 'How do you find publishers to pitch?', a: 'Manual outreach based on topical relevance to your niche, genuine organic traffic, and an editorial history of publishing outside contributors — not a rented list of sites that accept anything for a fee.' },
      { q: 'Can I choose the topics the guest posts cover?', a: "Yes. We propose angles based on keyword gaps and what the target publication's audience actually reads, but the final topic list is agreed with you before any drafting starts." },
      { q: 'How is this different from paying for a sponsored post?', a: 'A sponsored post is disclosed as paid placement and often marked with rel="sponsored". A genuine guest post is accepted on editorial merit — the publication wants the content for its own readers, which is what makes the resulting link carry more weight.' }
    ]
  },
  {
    slug: 'on-page-seo',
    ...
    points: [
      ...
      'Schema markup for FAQ, HowTo, and article rich results',
      'Content gap analysis against the pages currently outranking you'
    ],
    faqs: [
      ...
      { q: 'Do you rewrite existing content or just adjust the structure?', a: 'Both, depending on what the audit finds. Some pages just need header structure, internal links, and metadata fixed. Others are thin or outdated and need the actual content rewritten to match what\'s currently ranking for the target term.' },
      { q: 'How does on-page SEO relate to your keyword research service?', a: 'Keyword research tells you which terms to target and which page should own each one; on-page SEO is the execution — making sure that page is actually structured and written to rank for the term it\'s been assigned.' },
      { q: 'Will on-page changes affect my site\'s design?', a: 'Rarely in any visible way. Most on-page work happens in the HTML head, heading structure, and content itself — not the visual layout — though we\'ll flag it upfront on the few occasions a fix does touch something visible.' }
    ]
  },
  {
    slug: 'off-page-seo',
    ...
    points: [
      ...
      'Local citation building for location-based businesses',
      'Digital PR outreach for coverage and unlinked-mention recovery'
    ],
    faqs: [
      ...
      { q: 'What is an unlinked mention and why does it matter?', a: 'It\'s when a site mentions your brand name or cites your data without linking to you — common after PR coverage or a quoted stat. We find these and reach out to ask for the link, which is usually a much easier conversion than cold outreach.' },
      { q: 'Do citations matter if my business isn\'t local?', a: 'Less so. Citation building is primarily an off-page tactic for location-based and multi-location businesses; for a purely online business we weight the strategy toward link building and digital PR instead.' },
      { q: 'How does this fit with the link building service?', a: 'Link building executes individual placements; off-page SEO is the strategy deciding what mix of links, citations, and PR your specific competitive gap actually calls for, and in what order.' }
    ]
  },
  {
    ...
    faqs: [
      ...
      { q: 'What services can I resell through this arrangement?', a: 'The same range we offer directly: link building, guest posting, on-page and off-page SEO, and keyword research — mixed and matched per client, reported under your brand.' },
      { q: 'How do you keep quality consistent across different partner agencies\' clients?', a: 'The same vetting and process we use on direct clients applies here — manual outreach, no PBNs, the same reporting rigor — because our own reputation with search engines depends on every placement holding up, regardless of whose name is on the report.' }
    ]
  },
  {
    ...
    points: [
      ...
      'Search intent classified per keyword (informational, commercial, transactional)',
      'Cannibalization check across your existing pages before adding new targets'
    ],
    faqs: [
      ...
      { q: 'What is keyword cannibalization and do you check for it?', a: 'It\'s when two pages on the same site compete for the same term and split its ranking signal. We check your existing pages against every new target before adding it, so we consolidate instead of creating a new competing page.' },
      { q: 'Do you research keywords for AI search and chat assistants too?', a: 'Yes, where relevant — we look at how questions get phrased conversationally, not just as short search-box queries, since that increasingly determines whether AI Overviews and assistants cite a page at all.' },
      { q: 'How does this connect to your other services?', a: 'It\'s usually the starting point: the roadmap tells on-page SEO which page to optimize for which term, and tells link building and guest posting which pages need outside authority most.' }
    ]
  }
];
